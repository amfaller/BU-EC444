...
void app_main(void){
    ...
    while(1){
        ...
        // Convert voltage to temperature in K using B parameter equation found at https://en.wikipedia.org/wiki/Thermistor
        uint32_t temperature = 1 / ( (1/298.15) + (1/3435)*log( ((5000/voltage) - 1000) / 100000 ) );

        // Print to console
        printf("Raw: %d\tVoltage: %dmV\t Temp: %dC\n", adc_reading, voltage, temperature-273);

        // Display on 14-segment display
        Alnum_Disp(temperature-273);
