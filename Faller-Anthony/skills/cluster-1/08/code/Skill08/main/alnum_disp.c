/* EC444 Quest01 Skill08
*  Alphanumeric Display
*  September 10, 2020
*  Author: Tony Faller */

/* Note: This code is a modified version of i2c_display.c in the EC444 code-examples repo  */
...
void app_main() {
    ...
    /* Taken from Console I/O brief on course website */
    ...
    while(1){
      ...
      uint16_t displaybuffer[8];
      displaybuffer[0] = alphafonttable[ (int)buf[0] ];
      displaybuffer[1] = alphafonttable[ (int)buf[1] ];
      displaybuffer[2] = alphafonttable[ (int)buf[2] ];
      displaybuffer[3] = alphafonttable[ (int)buf[3] ];
