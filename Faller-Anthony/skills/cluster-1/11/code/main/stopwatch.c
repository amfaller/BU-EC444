/* EC444 Quest01 Skill11 
*  Building a Stopwatcg
*  September 17, 2020
*  Author: Tony Faller */

/* Note: This program reuses code from Skill10 and from the EC444 example timer-example.c*/
...
////////////////////////////////////////////////////////////////////////////////
// Timer Stuff /////////////////////////////////////////////////////////////////
//   Code taken from timer-example.c   /////////////////////////////////////////
...
static void timer_evt_task(void *arg) {
    ...
    while (1) {
        ...
        xQueueReceive(gpio_evt_queue, &io_num, portMAX_DELAY);	// Hardware interrupt

        // Increment / Wraparound when triggered
        if (evt.flag == 1) {
            if(num == 99 || gpio_get_level(io_num))
            	num = 0;
            else
            	num++;
            Alnum_Disp();
...
void app_main(void) {
	...
	/* Code from hardware interrupt example */
